...
export const navigationByRole: Record<UserRole, NavItem[]> = {
  master: [
    ...
    { href: "/dashboard/admin/planos", label: "Planos e recursos", icon: "package", permission: "admin.definir_planos", group: "Financeiro" },
  ...
  dono: [
    ...
    { href: "/dashboard/midia", label: "Mídia / Galeria", icon: "sparkles", permission: "owner.cadastro_servicos", group: "Cadastros" },
    ...
    { href: "/dashboard/notas", label: "Notas ao cliente", icon: "file", permission: "owner.emissao_pdf", group: "Operacional" },
    { href: "/dashboard/permissoes", label: "Permissões gerência", icon: "users", permission: "owner.cadastro_funcionarios", group: "RH" },
    { href: "/dashboard/notas/emitentes", label: "Emitentes (CNPJ)", icon: "building", permission: "owner.configurar_notas", group: "Cadastros" },
  ...
  gerencia: [
    ...
    { href: "/dashboard/notas", label: "Notas ao cliente", icon: "file", permission: "gerencia.emissao_notas", group: "Operacional" },
    { href: "/dashboard/cadastros", label: "Clientes e veículos", icon: "car", permission: "gerencia.cadastro_clientes", group: "Cadastros" },
